...
import { getAuth, type User, signInWithEmailAndPassword, signOut as firebaseSignOut, onAuthStateChanged } from 'firebase/auth'
...
export function useFirebaseAuth() {
  ...
  async function signIn(email: string, password: string) {
    ...
    if (!auth) {
      ...
      throw new Error('Não foi possível acessar o serviço de autenticação. Tente novamente mais tarde.')
    }
