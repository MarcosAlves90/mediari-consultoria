  ...
  <div class="admin-layout min-h-screen bg-body-bg">
    ...
    <nav class="sticky top-0 z-50 bg-body-bg border-accent-color border-b-2">
      <div class="max-w-7xl mx-auto px-0.5 300:px-0.75 500:px-1 870:px-1.5">
        <div
          class="flex justify-between items-start 500:items-center min-h-[70px] 500:h-5 py-1 500:py-0 gap-1 500:gap-0"
        >
          <!-- Logo e título -->
          <div class="flex items-center flex-shrink-0 group">
            ...
            >
              <Icon
                ...
                size="40"
                class="w-auto mr-1 500:mr-1.5 transition-all duration-200 filter drop-shadow-sm"
              />
              <div class="flex flex-col">
                <span
                  class="text-lg 500:text-xl font-medium text-gray-900 tracking-tight"
                >
                  Mediari
                </span>
                <span
                  class="text-xs 500:text-sm font-medium text-accent-color -mt-0.5"
                >
          ...
          <div class="flex items-center gap-1 500:gap-2">
            ...
            <div
              ...
              class="flex flex-col 300:flex-row gap-0.5 300:gap-1"
            >
              <!-- Admin Menu -->
              <NuxtLink
              ...
              >
                <span
                  class="relative flex items-center justify-center 500:justify-start"
                >
                  <Icon
                    name="mdi:account-group"
                    class="w-1 h-1 mr-0.5 500:mr-1"
                  />
    ...
    <Transition name="slide-fade-nav">
      <nav
        v-show="screenWidth < 500 && hamburguerMenuOpen"
    ...
    <footer class="bg-accent-color py-1.5 500:py-2">
      <div class="max-w-7xl mx-auto px-1 300:px-1.5 500:px-2 870:px-3">
        <div
          class="flex flex-col 500:flex-row items-center justify-between gap-1 500:gap-0"
        >
          <div
            class="text-center 500:text-left text-xs 500:text-sm text-body-bg"
          >
          ...
          <div class="flex items-center text-xs text-body-bg">
            <div
              class="w-0.5 h-0.5 bg-green-500 rounded mr-0.5 animate-pulse shadow-sm"
            ></div>
...
<script setup lang="ts">
  ...
  onMounted(async () => {
    try {
      ...
      console.warn('[layouts/admin] falha ao buscar sessão', e)
    }
  })
