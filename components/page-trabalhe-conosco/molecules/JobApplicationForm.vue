...
const CSS_CLASSES = {
  ...
  checkboxWrapper: 'flex items-start gap-0.75 mb-2 max-md:gap-0.5 max-md:mb-1.5',
  checkboxInput:
  ...
  checkboxLabel: 'text-xs text-primary-text leading-relaxed cursor-pointer select-none',
  submitButton: 'common-button w-full text-base font-medium !min-h-[48px] mt-1.5 disabled:opacity-50 disabled:cursor-not-allowed max-md:!min-h-[42px] max-md:mt-1',
} as const;
</script>
...
<template>
  <div class="job-application-form">
    ...
    <form @submit.prevent="handleSubmit" class="careers__form-container grid gap-0 max-md:grid-cols-1">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 max-lg:gap-0">
        ...
        <div :class="CSS_CLASSES.formGroup">
          ...
          <input id="fullName" v-model="formData.fullName" type="text" :class="[
            CSS_CLASSES.formInput,
            errors.fullName ? 'border-accent-color' : '',
          ]" :placeholder="t('careers.form.full_name_placeholder')" required />
        ...
        <div :class="CSS_CLASSES.formGroup">
          ...
          ]" :placeholder="t('careers.form.email_placeholder')" required />
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 max-lg:gap-0">
        ...
        <div :class="CSS_CLASSES.formGroup">
          ...
          ]" :placeholder="t('careers.form.phone_placeholder')" @input="handlePhoneInput" maxlength="15"
            required />
        ...
        <div :class="CSS_CLASSES.formGroup">
          ...
          <select id="areaOfInterest" v-model="formData.areaOfInterest" :class="[
      ...
      <div :class="CSS_CLASSES.formGroup">
        ...
        <textarea id="experience" v-model="formData.experience" :class="[
          CSS_CLASSES.formTextarea,
          errors.experience ? 'border-accent-color' : '',
        ]" :placeholder="t('careers.form.experience_placeholder')" required></textarea>
      ...
      <!-- Resume Upload -->
      <div :class="CSS_CLASSES.formGroup">
        <FileUpload id="resume" :label="t('careers.form.resume')" v-model="formData.resume" accept=".pdf,.doc,.docx"
          :error-message="errors.resume" required @error="(message) => errors.resume = message" />
      </div>
      ...
      <div :class="CSS_CLASSES.formGroup">
        ...
        <textarea id="coverLetter" v-model="formData.coverLetter" :class="CSS_CLASSES.formTextarea"
          :placeholder="t('careers.form.cover_letter_placeholder')"></textarea>
      </div>

      <!-- Privacy Consent -->
      <div :class="CSS_CLASSES.checkboxWrapper">
        <input id="privacyConsent" v-model="formData.privacyConsent" type="checkbox" :class="[
      ...
      <!-- Submit Button -->
      <button type="submit" :class="CSS_CLASSES.submitButton" :disabled="isSubmitting || !isFormComplete">
