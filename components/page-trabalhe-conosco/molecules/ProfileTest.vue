...
const scale_option = "flex flex-col items-center cursor-pointer transition-all duration-200 p-0.5 rounded text-center";
    ...
    <div class="profile-test">
        ...
        <div class="text-center mb-2">
            <span class="text-sm text-secondary-text">
                {{ t("careers.profile_test.progress_text", { answered: Object.keys(profileTestAnswers).length, total: (GROUPS || []).length }) }}
            </span>
        </div>
