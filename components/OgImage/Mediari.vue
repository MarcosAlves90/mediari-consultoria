...
<template>
  <div
    class="h-full w-full flex items-center justify-center border-solid"
    :style="{
      background:
        'linear-gradient(90deg, #590100 0%, #480000 50%, #590100 100%)',
    }"
  >
        ...
        <div class="flex items-center justify-center w-full py-8 gap-7">
          ...
          >
            ...
            <path
              fill="#f5f5f5"
              stroke-width="0"
              d="M165.45,41.94v9.06h-1.18v-9.06h1.18Z"
            />
            <path
              fill="#f5f5f5"
              stroke-width="0"
            ...
            <path
              fill="#f5f5f5"
              stroke-width="0"
              d="M116.21,41.94v.96h-2.47v8.1h-1.18v-8.1h-2.48v-.96h6.14Z"
            />
            <path
              fill="#f5f5f5"
              stroke-width="0"
              d="M96.72,50.04h3.17v.96h-4.35v-9.06h1.18v8.1Z"
            />
            <path
              fill="#f5f5f5"
              stroke-width="0"
