...
<template>
    <div class="contact-card mx-auto my-0 box-border flex w-full flex-col items-center justify-center gap-1"
        data-testid="contact-card">
        <div class="contact-card__square relative w-full h-20 overflow-hidden rounded-sm max-w-full max-lg:h-full">
            <div
                ...
                <NuxtImg :src="backgroundImage" alt="Background" provider="cloudinary"
        ...
        <button class="contact-card__button common-button w-full text-base self-center max-lg:text-xs"
            @click.prevent="buttonAction">{{ buttonText }}</button>
    </div>
</template>
