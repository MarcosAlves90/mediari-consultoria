    ...
    <div class="profile-test">
        ...
        <div class="text-center mb-2">
            <span class="text-sm text-secondary-text">
                {{ t("careers.profile_test.progress_text", { answered: Object.keys(profileTestAnswers).length, total: profileQuestions.length }) }}
            </span>
        </div>
...
const scale_container = "flex justify-between items-center gap-0.5 max-md:flex-col max-md:gap-0.75 max-md:items-start";
const scale_option = "flex flex-col items-center cursor-pointer transition-all duration-200 p-0.375 rounded max-md:flex-row max-md:gap-0.5 max-md:justify-start";
const scale_radio = "w-1.5 h-1.5 cursor-pointer accent-accent-color max-md:w-1.5 max-md:h-1.5";
